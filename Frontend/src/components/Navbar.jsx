...
const Navbar = () => {
  ...
  return (
    <nav className="w-full  fixed top-0 right-0 left-0 container mx-auto xl:px-16 py-3 lg:px-10 md:px-5 px-5 flex flex-col md:flex-row justify-between items-center transition-colors duration-500  z-50">
